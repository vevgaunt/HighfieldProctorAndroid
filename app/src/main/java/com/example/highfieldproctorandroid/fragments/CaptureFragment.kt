...
import com.example.highfieldproctorandroid.databinding.FragmentCaptureBinding
import com.example.highfieldproctorandroid.extensions.getAspectRatio
...
class CaptureFragment : Fragment() {
    ...
    private val navController: NavController by lazy {
        Navigation.findNavController(requireActivity(), R.id.fragment_video_container)
    }
